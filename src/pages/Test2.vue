<template>
  ...
  <main class="container-fluid">
    ...
    <!-- <div class="row p-5 justify-content-center">
      <div class="col-md-3 col-10 position-relative d-flex justify-content-center my-3" v-for="(image, index) in images"
        :key="index">
        <img class="oranges rounded" :src="image.src" alt="">
        <button class="btn bg-pink text-darkOrange purchase-btn">Purchase</button>
      </div>
    </div> -->
...
export default {
  data() {
    return {
      sections: [
        { title: "Our Oranges", description: "Our oranges are the fuzziest and juiciest." },
        { title: "Shop the Selection", description: "Browse and buy our delectable citri." },
        { title: "Contact Us", description: "Need information? Send us a squeeze!" }
      ],
      imageIndex: 0,
      images: [
