...
export default {
  setup() {
    ...
    const merchItems = ref([
      { id: 1, type: 'mugs', image: '/img/ShopImages/BrownMug.png', description: '16 oz Brown Mug', price: '$12.95', paypalButtonId: 'NYL23AU9VCWQ2' },
      { id: 2, type: 'mugs', image: '/img/ShopImages/BlueDarkblueMug.png', description: '16 oz Light Blue Mug', price: '$12.95', paypalButtonId: 'HTU5ZW7H9G64U' },
      { id: 3, type: 'mugs', image: '/img/ShopImages/BlueMug.png', description: '16 oz Dark Blue Mug', price: '$12.95', paypalButtonId: 'UQNBC7PT47WYS' },
      { id: 4, type: 'mugs', image: '/img/ShopImages/ClearMug.png', description: '12 oz Glass Mug', price: '$12.95', paypalButtonId: 'WURX3BPSWJJC4' },
      { id: 5, type: 'mugs', image: '/img/ShopImages/GreyOrangeMug.png', description: '16 oz Grey/Orange Mug', price: '$12.95', paypalButtonId: 'BLX9W78Q85NWS' },
      { id: 6, type: 'mugs', image: '/img/ShopImages/CornerMug.png', description: 'Goldys Corner 12 oz Mug', price: '$12.95', paypalButtonId: 'XLSA6UX2KH832' },
      { id: 7, type: 'coffee', image: '/img/ShopImages/GroundCoffeeBeans.png', description: 'Dawson Taylor Ground Coffee', price: '$15.95', paypalButtonId: 'TJ63CA4FWK54Q' },
      { id: 8, type: 'coffee', image: '/img/ShopImages/WholeCoffeeBeans.png', description: 'Dawson Taylor Whole Coffee Beans', price: '$15.95', paypalButtonId: '5VTDUAGXCCW8G' },
      { id: 9, type: 'hats', image: '/img/ShopImages/Beanie.png', description: 'Black Beanie', price: '$18.95', paypalButtonId: 'LJJ4E24V9Y7XQ' },
      // { id: 10, type: 'misc', image: '/img/ShopImages/Chapstick.png', description: 'Goldys Chap Stick', price: '$2.00', paypalButtonId: 'JR37TTV8MXRBU' },
      { id: 10, type: 'misc', image: '/img/ShopImages/GiftCard.png', description: 'Gift Card, works at restaurant and corner', price: '$2.00', paypalButtonId: 'KKWVD7WUR2RRL' },
      { id: 11, type: 'misc', image: '/img/ShopImages/ChampagneGlass.png', description: 'Champagne Glass', price: '$10.95', paypalButtonId: 'RUYB6NBTEL77E' },
      { id: 12, type: 'misc', image: '/img/ShopImages/WaterBottle.png', description: 'Water Bottle', price: '$14.95', paypalButtonId: 'P2UZJGLLXLD88' },
      { id: 13, type: 'misc', image: '/img/ShopImages/Tumbler.png', description: 'Tumbler', price: '12.95', paypalButtonId: 'EKAQYT99LPJCC' },
      { id: 14, type: 'misc', image: '/img/ShopImages/GoldysSpice.png', description: 'Goldys Spice Mix', price: '$12.95', paypalButtonId: '9KMJJ33MBQ87A' },
      { id: 15, type: 'misc', image: '/img/ShopImages/GreenThermos.png', description: 'Green Thermos', price: '$16.95', paypalButtonId: '7QWGY7NKFF3CA' },
      { id: 16, type: 'misc', image: '/img/ShopImages/OrangeThermos.png', description: 'Orange Thermos', price: '$16.95', paypalButtonId: '29CM3AUGAJ56J' },
      { id: 17, type: 'hats', image: '/img/ShopImages/BlueTruckerHat1.png', description: 'Blue Trucker Hat', price: '$25.95', paypalButtonId: 'AG5UKR4WFEDUA' },
      ...
      { id: 19, type: 'hats', image: '/img/ShopImages/DadHat1.png', description: 'Yellow Dad Hat', price: '$25.95', paypalButtonId: '8AJ4LRC47B3XW' },
